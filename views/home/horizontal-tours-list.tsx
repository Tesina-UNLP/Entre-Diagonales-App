        ...
        renderItem={({ item }) => (
          <View style={styles.routeItemContainer}>
            <View style={styles.routeCard}>
              <Image
                source={{
                  uri: item?.spots?.[0]?.image_urls[0] || "https://images.unsplash.com/photo-1600591832245-9a9f49ec6f5a?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bGElMjBwbGF0YXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=400"
                }}
              ...
              <View style={styles.routeCardInfo}>
                ...
                <ThemedText type="defaultSemiBold" style={styles.routeCardTitle}>
                  {item?.name}
                </ThemedText>
                <View style={styles.routeCardFooterRow}>
                  <View style={styles.routeCardDistanceRow}>
                    <MaterialIcons name="place" size={16} color={TOKENS.text} />
...
const styles = StyleSheet.create({
  ...
  recommendedHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  viewAllText: { color: TOKENS.navActive },
  routeItemContainer: { marginRight: 12 },
  routeCard: { width: 180, height: 223, borderRadius: 12, overflow: "hidden", backgroundColor: "rgba(0,0,0,0.06)" },
  routeCardImage: { width: "100%", height: "100%", position: "absolute", top: 0, left: 0, opacity: 0.6 },
  routeCardOverlay: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(0,0,0,0.05)" },
  routeCardInfo: { position: "absolute", bottom: 8, left: 15, right: 15 },
  routeCardTagRow: { flexDirection: "row", alignItems: "center", gap: 4, marginBottom: 4 },
  routeCardText: { color: TOKENS.text },
  routeCardTitle: { color: TOKENS.text },
  routeCardFooterRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 4 },
